...
public class FMImageEditorViewController: UIViewController {
    ...
    override public func viewDidLoad() {
        ...
        DispatchQueue.main.async {
            ...
            // default color
            self.filterMenuButton.setTitleColor(UIColor.black, for: .normal)
            //self.filterMenuButton.tintColor = UIColor.blue
            let filterMenuButtonColor = UIColor(hex: 0x0A84FF)
            self.filterMenuButton.tintColor = filterMenuButtonColor
            
            self.cropMenuButton.setTitleColor(UIColor.black, for: .normal)
            let cropMenubuttonMenuColor = UIColor(hex: 0x0A84FF)
            self.cropMenuButton.tintColor = cropMenubuttonMenuColor
    ...
    private func openFiltersMenu() {
        ...
        filterMenuButton.setTitleColor(.black, for: .normal)
        
        let cropMenubuttonMenuColor = UIColor(hex: 0x0A84FF)
        self.cropMenuButton.tintColor = cropMenubuttonMenuColor
        //cropMenuButton.tintColor = UIColor.blue
        cropMenuButton.setTitleColor(UIColor.black, for: .normal)
...
private extension FMImageEditorViewController {
    func setupView() {
        ...
        //let filterMenuButtonColor = UIColor(hex: 0x0A84FF)
        //self.filterMenuButton.tintColor = filterMenuButtonColor
        headerSeparator.backgroundColor = kBackgroundColor
       ...
       // let subMenuContainerColor = UIColor(hex: 0x0A84FF)
