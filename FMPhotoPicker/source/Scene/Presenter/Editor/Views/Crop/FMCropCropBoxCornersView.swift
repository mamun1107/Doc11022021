...
class FMCropCropBoxCornersView: UIView {
    ...
    init() {
        ...
        topLeftView.backgroundColor = UIColor(hex: 0x0A84FF)
        topRightView.backgroundColor = UIColor(hex: 0x0A84FF)
        
        rightTopView.backgroundColor = UIColor(hex: 0x0A84FF)
        rightBottomView.backgroundColor = UIColor(hex: 0x0A84FF)
        
        bottomRightView.backgroundColor = UIColor(hex: 0x0A84FF)
        bottomLeftView.backgroundColor = UIColor(hex: 0x0A84FF)
        
        leftBottomView.backgroundColor = UIColor(hex: 0x0A84FF)
        leftTopView.backgroundColor = UIColor(hex: 0x0A84FF)
